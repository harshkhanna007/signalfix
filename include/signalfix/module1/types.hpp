...
// ---------------------------------------------------------------------------
// Status flag helpers — constexpr, zero-overhead
// ---------------------------------------------------------------------------
...
// =============================================================================
// derive_trust_tier — Deterministic mapping from status flags
// =============================================================================
...
// =============================================================================
// failure_upgrade — Hierarchical failure management
// =============================================================================

/**
 * upgrade_failure_hint
 *
 * Implements the severity hierarchy: NONE < DRIFT < GAP < STALE < SPIKE < INVALID.
 * A stage may only upgrade the hint if the suggested mode has higher severity.
 * INVALID always overrides immediately with 1.0 confidence.
 */
...
// =============================================================================
// validate_status_flags — Architecture invariant enforcement
// =============================================================================
